...
wget https://archive.apache.org/dist/spark/spark-2.4.8/spark-2.4.8-bin-hadoop2.7.tgz &> /dev/null
tar -xzf spark-2.4.8-bin-hadoop2.7.tgz
mv spark-2.4.8-bin-hadoop2.7 /usr/local/spark

# Download Kafka Lib
wget -O /usr/local/spark/jars/spark-streaming-kafka-0-8-assembly_2.11-2.4.7.jar https://repo1.maven.org/maven2/org/apache/spark/spark-streaming-kafka-0-8-assembly_2.11/2.4.7/spark-streaming-kafka-0-8-assembly_2.11-2.4.7.jar
